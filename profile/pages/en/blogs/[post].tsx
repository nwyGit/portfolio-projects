...
export default function EnglishBlogPost({ post, faqs }: BlogPostPageProps) {
	...
	const localizedFAQs = getLocalizedFAQs(faqs, 'en');
		...
		<Layout>
			...
			<main className="container mx-auto px-4 py-8 max-w-4xl">
				...
				<header className="mb-8">
					...
					<div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 mb-6">
						...
						<time dateTime={localizedPost.publishedAt}>
							{messages.publishedOn} {new Date(localizedPost.publishedAt).toLocaleDateString('en-US', {
								year: 'numeric',
								month: 'long',
								day: 'numeric',
							})}
				...
				{localizedFAQs.length > 0 && (
					<BlogFAQSection faqs={localizedFAQs} language="en" />
				)}
			</main>
		</Layout>
	);
